...
export const env = createEnv({
  server: {
    ...
    AI_MODEL_ONBOARDING: z.string().optional(),
    AI_MODEL_POLICY_UPDATE: z.string().optional(),
    AI_MODEL_RERANK: z.string().optional(),
  ...
  runtimeEnv: {
    ...
    AI_MODEL_ONBOARDING: process.env.AI_MODEL_ONBOARDING,
    AI_MODEL_POLICY_UPDATE: process.env.AI_MODEL_POLICY_UPDATE,
    AI_MODEL_RERANK: process.env.AI_MODEL_RERANK,
